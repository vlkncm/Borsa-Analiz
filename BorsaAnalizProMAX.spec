...
a = Analysis(
    ...
    hiddenimports=['main', 'bist30', 'veri_saglayici', 'bist_bulteni', 'borsa_tarayici', 'pro_moduller', 'kap_modulu', 'backtest', 'intraday_backtest', 'intraday_gostergeler', 'gunluk_trade_motoru', 'mum_formasyonlari', 'mtf_grafik', 'olasilik_temettu', 'faaliyet_raporu', 'piyasa_guncelleme', 'sistem_kontrol', 'v4_puanlama', 'formasyon_motoru', 'takip_modulu', 'fibonacci_motoru', 'karar_motoru', 'satis_karar_motoru', 'vade_motoru', 'profesyonel_analiz'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=[],
